...
AS per_german_pop FROM world WHERE continent = 'Europe'
...
-- Question 8
SELECT DISTINCT continent, (SELECT name FROM world AS y WHERE y.continent = x.continent ORDER BY name LIMIT 1)
FROM world AS x


-- Question 9
SELECT name, continent, population FROM world
WHERE continent NOT IN (SELECT continent FROM world WHERE population > 25000000 GROUP BY continent);
